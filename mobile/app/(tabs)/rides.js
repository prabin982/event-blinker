  ...
  return (
    <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
      <View style={styles.riderHero}>
        <LinearGradient colors={["#34D399", "#059669"]} style={styles.riderHeroBg} />
        ...
        <View style={styles.statusCard}>
          <View style={[styles.statusIconContainer, status === 'approved' && styles.iconApproved]}>
            <Ionicons
              ...
              size={60}
              color={status === 'approved' ? '#34D399' : status === 'rejected' ? '#F87171' : '#FF6B35'}
            />
          </View>
...
const styles = StyleSheet.create({
  ...
  header: { paddingHorizontal: 16, paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.04)", backgroundColor: "#0D1120" },
  headerTitle: { fontSize: 24, fontWeight: "800", color: "#F0F2F8", letterSpacing: -0.3 },
  headerTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  modeToggle: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: '#FF6B35', paddingVertical: 7, paddingHorizontal: 14, borderRadius: 20 },
  modeToggleRider: { backgroundColor: '#34D399' },
  modeToggleText: { color: '#FFF', fontSize: 11, fontWeight: '700' },
  tabContainer: { flexDirection: "row", paddingHorizontal: 16, paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.04)", backgroundColor: "#0D1120" },
  tab: { flex: 1, paddingVertical: 12, alignItems: "center", borderBottomWidth: 2, borderBottomColor: "transparent", borderRadius: 8 },
  activeTab: { borderBottomColor: "#FF6B35", backgroundColor: "rgba(255,107,53,0.06)" },
  tabText: { fontSize: 16, color: "#4D5675", fontWeight: "500" },
  activeTabText: { color: "#FF6B35", fontWeight: "700" },
  content: { flex: 1 },
  sectionTitle: { fontSize: 20, fontWeight: "800", color: "#F0F2F8", marginBottom: 16, letterSpacing: -0.3 },
  centerContainer: { flex: 1, justifyContent: "center", alignItems: "center", padding: 20 },
  loginButton: { backgroundColor: "#FF6B35", paddingVertical: 14, paddingHorizontal: 28, borderRadius: 14, marginTop: 16, shadowColor: "#FF6B35", shadowOpacity: 0.3, shadowRadius: 12, elevation: 8 },
  loginButtonText: { color: "#fff", fontSize: 16, fontWeight: "800" },
  emptyText: { fontSize: 14, color: "#4D5675", marginTop: 12 },
  riderHero: { margin: 16, padding: 22, borderRadius: 25, overflow: 'hidden', position: 'relative' },
  ...
  heroStatusText: { fontSize: 12, color: 'rgba(255,255,255,0.75)', marginTop: 2 },
  statusToggle: { paddingVertical: 10, paddingHorizontal: 20, borderRadius: 15, backgroundColor: 'rgba(255,255,255,0.95)' },
  statusToggleText: { fontSize: 13, fontWeight: '900', color: '#34D399' },
  statusOffline: { backgroundColor: '#F87171' },
  statusOnline: { backgroundColor: 'rgba(255,255,255,0.95)' },
  statsRow: { flexDirection: 'row', backgroundColor: 'rgba(0,0,0,0.2)', borderRadius: 20, padding: 15, zIndex: 1, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
  ...
  statLab: { color: 'rgba(255,255,255,0.55)', fontSize: 9, fontWeight: '600', textTransform: 'uppercase' },
  ...
  placeholderText: { fontSize: 18, fontWeight: '700', color: '#6B7599', marginTop: 15 },
  placeholderSubText: { fontSize: 14, color: '#4D5675', textAlign: 'center', marginTop: 8, paddingHorizontal: 40 },
  emptyRequests: { alignItems: 'center', marginTop: 40, opacity: 0.6 },
  reqCard: { backgroundColor: '#151A2D', borderRadius: 20, padding: 18, marginBottom: 15, borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)', shadowColor: '#000', shadowOpacity: 0.2, shadowRadius: 10, elevation: 4 },
  ...
  passengerName: { fontSize: 16, fontWeight: '700', color: '#F0F2F8' },
  reqMetaRow: { flexDirection: 'row', alignItems: 'center', gap: 5, marginTop: 2 },
  reqDistance: { fontSize: 11, color: '#6B7599' },
  reqPrice: { fontSize: 18, fontWeight: '800', color: '#34D399' },
  ...
  dotDropoff: { width: 8, height: 8, borderRadius: 4, backgroundColor: '#34D399', position: 'absolute', bottom: 0 },
  connector: { width: 2, height: 30, backgroundColor: 'rgba(255,255,255,0.08)', position: 'absolute', top: 8, left: 3 },
  pathTexts: { marginLeft: 20, justifyContent: 'space-between' },
  pathAddr: { fontSize: 13, color: '#8892B0', width: Dimensions.get('window').width * 0.7 },
  reqActions: { marginTop: 5 },
  btnAccept: { backgroundColor: '#34D399', paddingVertical: 14, borderRadius: 15, alignItems: 'center', shadowColor: '#34D399', shadowOpacity: 0.3, shadowRadius: 8, elevation: 6 },
  btnAcceptText: { color: '#FFF', fontWeight: '900', fontSize: 14, letterSpacing: 1 },
  segmentPicker: { flexDirection: 'row', backgroundColor: 'rgba(255,255,255,0.04)', marginHorizontal: 20, borderRadius: 15, padding: 4, borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)' },
  segmentBtn: { flex: 1, paddingVertical: 10, alignItems: 'center', borderRadius: 12 },
  segmentBtnActive: { backgroundColor: '#151A2D', shadowColor: '#000', shadowOpacity: 0.2, shadowRadius: 6, elevation: 3, borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)' },
  segmentText: { fontSize: 13, fontWeight: '600', color: '#4D5675' },
  segmentTextActive: { color: '#F0F2F8', fontWeight: '800' },
  historyCard: { backgroundColor: '#151A2D', padding: 16, borderRadius: 16, marginBottom: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)' },
  historyRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  historyName: { fontSize: 16, fontWeight: '700', color: '#F0F2F8' },
  historyDate: { fontSize: 12, color: '#6B7599', marginTop: 2 },
  historyStatus: { fontSize: 10, fontWeight: '800', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 6, overflow: 'hidden' },
  statuscompleted: { backgroundColor: 'rgba(52,211,153,0.12)', color: '#34D399' },
  statuscancelled: { backgroundColor: 'rgba(248,113,113,0.12)', color: '#F87171' },
  statusin_progress: { backgroundColor: 'rgba(251,191,36,0.12)', color: '#FBBF24' },
  historyPrice: { fontSize: 14, fontWeight: '800', color: '#F0F2F8', marginTop: 10 },
  promoGradient: { ...StyleSheet.absoluteFillObject },
  bookingCard: { backgroundColor: '#151A2D', margin: 16, borderRadius: 25, padding: 22, borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)', shadowColor: '#000', shadowOpacity: 0.3, shadowRadius: 15, elevation: 6 },
  locationContainer: { flexDirection: 'row', backgroundColor: 'rgba(255,255,255,0.03)', borderRadius: 20, padding: 16, marginBottom: 20, borderWidth: 1, borderColor: 'rgba(255,255,255,0.04)' },
  ...
  dotEnd: { width: 10, height: 10, borderRadius: 5, backgroundColor: '#34D399' },
  lineConnector: { width: 2, flex: 1, backgroundColor: 'rgba(255,255,255,0.08)', marginVertical: 4 },
  locationRight: { flex: 1, marginLeft: 15 },
  locationItem: { paddingVertical: 8 },
  locationLabel: { fontSize: 10, fontWeight: '800', color: '#6B7599', letterSpacing: 1 },
  locationValue: { fontSize: 15, fontWeight: '700', color: '#F0F2F8', marginTop: 4 },
  locationPlaceholder: { color: '#4D5675', fontWeight: '500' },
  hDivider: { height: 1, backgroundColor: 'rgba(255,255,255,0.04)', marginVertical: 8 },
  subHeader: { fontSize: 16, fontWeight: '800', color: '#F0F2F8', marginBottom: 15 },
  vehicleRow: { flexDirection: 'row', gap: 10, marginBottom: 20 },
  vehicleBtn: { flex: 1, backgroundColor: 'rgba(255,255,255,0.03)', borderRadius: 20, padding: 15, alignItems: 'center', borderWidth: 2, borderColor: 'rgba(255,255,255,0.04)' },
  vehicleBtnActive: { borderColor: 'rgba(255,107,53,0.4)', backgroundColor: 'rgba(255,107,53,0.08)' },
  vehicleName: { fontSize: 13, fontWeight: '800', color: '#6B7599', marginTop: 8 },
  vehicleNameActive: { color: '#F0F2F8' },
  vehicleRate: { fontSize: 9, color: '#4D5675', marginTop: 2 },
  estimateBox: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: 'rgba(255,107,53,0.08)', padding: 16, borderRadius: 16, marginBottom: 20, borderWidth: 1, borderColor: 'rgba(255,107,53,0.15)' },
  estLabel: { fontSize: 10, fontWeight: '800', color: '#FF6B35' },
  estValue: { fontSize: 20, fontWeight: '900', color: '#F0F2F8' },
  estMeta: { alignItems: 'flex-end' },
  estMetaText: { fontSize: 12, fontWeight: '700', color: '#8892B0' },
  mainBookBtn: { backgroundColor: '#FF6B35', flexDirection: 'row', height: 60, borderRadius: 20, justifyContent: 'center', alignItems: 'center', gap: 10, shadowColor: '#FF6B35', shadowOpacity: 0.35, shadowRadius: 14, elevation: 10 },
  mainBookBtnDisabled: { backgroundColor: '#2A3050', shadowOpacity: 0 },
  mainBookBtnText: { color: '#FFF', fontSize: 18, fontWeight: '900', letterSpacing: 1 },
  mapPreviewContainer: { height: 160, marginHorizontal: -22, marginTop: -22, marginBottom: 20, borderTopLeftRadius: 25, borderTopRightRadius: 25, overflow: 'hidden', backgroundColor: '#1C2240' },
  ...
  distBadge: { backgroundColor: '#151A2D', paddingVertical: 5, paddingHorizontal: 11, borderRadius: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
  distBadgeText: { fontSize: 12, fontWeight: '800', color: '#F0F2F8' },
  loginPromptTitle: { fontSize: 22, fontWeight: "800", color: "#F0F2F8", marginTop: 20 },
  loginPromptText: { fontSize: 14, color: "#6B7599", textAlign: 'center', marginTop: 10, paddingHorizontal: 40 },
  statusCard: { margin: 20, padding: 30, backgroundColor: "#151A2D", borderRadius: 30, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)', shadowColor: "#000", shadowOpacity: 0.3, shadowRadius: 20, elevation: 10 },
  statusIconContainer: { padding: 20, backgroundColor: "rgba(255,107,53,0.08)", borderRadius: 40, marginBottom: 20 },
  iconApproved: { backgroundColor: "rgba(52,211,153,0.1)" },
  statusTitle: { fontSize: 24, fontWeight: "800", color: "#F0F2F8" },
  statusDescription: { fontSize: 15, color: "#8892B0", textAlign: 'center', marginTop: 10, lineHeight: 22 },
  dashboardBtn: { flexDirection: "row", alignItems: 'center', gap: 10, backgroundColor: "#FF6B35", paddingVertical: 15, paddingHorizontal: 25, borderRadius: 20, marginTop: 25, shadowColor: "#FF6B35", shadowOpacity: 0.3, shadowRadius: 10, elevation: 6 },
  dashboardBtnText: { color: "#FFF", fontSize: 16, fontWeight: "700" },
  rejectionBox: { marginTop: 20, alignItems: 'center' },
  rejectionReason: { color: "#F87171", fontSize: 14, fontWeight: "600", textAlign: 'center' },
  retryBtn: { marginTop: 15, paddingVertical: 10, paddingHorizontal: 20, borderWidth: 1, borderColor: "#FF6B35", borderRadius: 14 },
  retryBtnText: { color: "#FF6B35", fontWeight: "700" },
  benefitsSection: { padding: 20 },
  benefitsTitle: { fontSize: 18, fontWeight: "800", color: "#F0F2F8", marginBottom: 15 },
  benefitItem: { flexDirection: "row", gap: 15, alignItems: 'center', marginBottom: 20, backgroundColor: "#151A2D", padding: 18, borderRadius: 20, borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)' },
  benefitTextTitle: { fontSize: 16, fontWeight: "700", color: "#F0F2F8" },
  benefitTextSub: { fontSize: 13, color: "#6B7599" },
  ...
  registerStartBtn: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: "rgba(255,255,255,0.95)", paddingVertical: 10, paddingHorizontal: 16, borderRadius: 12, alignSelf: 'flex-start', marginTop: 15 },
  ...
  stepsTitle: { fontSize: 18, fontWeight: "800", color: "#F0F2F8", marginBottom: 20, marginLeft: 10 },
  stepItem: { flexDirection: 'row', gap: 15, marginBottom: 25 },
  stepNumberContainer: { width: 36, height: 36, borderRadius: 18, backgroundColor: "#FF6B35", justifyContent: 'center', alignItems: 'center', shadowColor: '#FF6B35', shadowOpacity: 0.3, shadowRadius: 6, elevation: 4 },
  stepNumber: { color: "#FFF", fontWeight: "800" },
  stepContent: { flex: 1 },
  stepItemTitle: { fontSize: 16, fontWeight: "800", color: "#F0F2F8" },
  stepItemDesc: { fontSize: 14, color: "#6B7599", marginTop: 4 },

  phoneWarning: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,107,53,0.08)', padding: 14, borderRadius: 15, marginBottom: 15, gap: 8, borderWidth: 1, borderColor: 'rgba(255,107,53,0.15)' },
  phoneWarningText: { flex: 1, fontSize: 13, color: '#F0F2F8', fontWeight: '600' },

  myRidesSection: { padding: 20 },
  emptyRecent: { alignItems: 'center', marginTop: 30 },
